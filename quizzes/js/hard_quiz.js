...
function switch_image() {
  if (num < 5 && num > 0) {
    document.getElementById("background").classList.remove("hard_second_background");
    document.getElementById("background").classList.add("hard_first_background");
  } else{
    document.getElementById("background").classList.remove("hard_first_background");
    document.getElementById("background").classList.add("hard_second_background");
  }
}
