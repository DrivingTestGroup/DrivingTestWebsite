...
<html>
  <head>
    ...
    <link rel="stylesheet" type="text/css" href="What_is_the_G1_Test_styles.css">
  </head>
  <body>
    <div class="content">
      <div id='para'> 
        <h1>What is the G1 Test?</h1>
        <p class="paragraph">All new drivers in Ontario must take a G1 knowledge test (also known as G1 written test). The official test is created by 
  the Ministry of Transportation (MTO) and is offered in all DriveTest Centres. The test is available on paper at 
    <a class="info_link" href='https://drivetest.ca/find-a-drive-test-centre/find_a_drivetest_centre.html#/locations'>
  all locations across Ontario</a>, and on computers at some locations. No appointment is required (make sure you come at least one hour before the DriveTest 
