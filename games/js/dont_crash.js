...
var myOb = ["../pictures/games/dont_crash/car3.png", "../pictures/games/dont_crash/car2.png", "../pictures/games/dont_crash/car4.png", "../pictures/games/dont_crash/car5.png"];

var myPed = ["../pictures/games/dont_crash/man1.png", "../pictures/games/dont_crash/man2.png"];
...
function startGame() {
    ...
    myGamePiece = new component(80, 50, "../pictures/games/dont_crash/car.png", 10, 120, "image"); 
...
var myGameArea = {
    ...
    start : function() {
        ...
        document.getElementById("gameWindow").insertBefore(this.canvas, document.getElementById("gameWindow").childNodes[0]);
        this.frameNo = 0;
...
//locks the window scroll bar once the gamearea senses the up or down key
  if (myGameArea.key && myGameArea.key == 37 || myGameArea.key && myGameArea.key == 65) {myGamePiece.speedX = -1; }

  if (myGameArea.key && myGameArea.key == 39 || myGameArea.key && myGameArea.key == 68) {myGamePiece.speedX = 1; }

  if (myGameArea.key && myGameArea.key == 38 || myGameArea.key && myGameArea.key == 87) { myGamePiece.speedY = -1;}

  if (myGameArea.key && myGameArea.key == 40 || myGameArea.key && myGameArea.key == 83) {myGamePiece.speedY = 1;}
    ...
    grass2.update();
      ...
      if (myGameArea.frameNo == 50 || everyinterval(300)) {
        ...
        gas.push(new component(30, 30, "../pictures/games/dont_crash/green.png", x, y, "image"));
